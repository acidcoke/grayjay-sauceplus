# grayjay-plugin-types

## Getting started

## To-Do

Don't distribute the ts file
remove the typings packages from dependencies and move them to dev dependencies
...
```shell
cd existing_repo
git remote add origin https://gitlab.com/kaidelorenzo/grayjay-plugin-types.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kaidelorenzo/grayjay-plugin-types/-/settings/integrations)
